...
# WRITE YOUR SOLUTION BELOW:
FIRST_OUTPUT_VALUE=$(bitcoin-cli -regtest decoderawtransaction $BASE_TX | jq -r '.vout | .[0] | .value' | awk '{s+=$1} END {print int(s*1000000 + 0.5)}')
